...
class FOMOnet(nn.Module):
    ...
    def __init__(self, num_channels=4):
        ...
        self.conv_encoder1 = self.conv_block(num_channels, 16)
        self.conv_encoder2 = self.conv_block(16, 32)
        self.conv_encoder3 = self.conv_block(32, 64)
        self.conv_encoder4 = self.conv_block(64, 128)
        self.conv_encoder5 = self.conv_block(128, 256)
        self.conv_encoder6 = self.conv_block(256, 512)
        self.bottleneck = self.conv_block(512, 512)

        self.res_encoder1 = self.res_block(num_channels, 16)
        self.res_encoder2 = self.res_block(16, 32)
        self.res_encoder3 = self.res_block(32, 64)
        self.res_encoder4 = self.res_block(64, 128)
        self.res_encoder5 = self.res_block(128, 256)
        self.res_encoder6 = self.res_block(256, 512)
        self.res_bottleneck = self.res_block(512, 512)

        self.conv_decoder4 = self.conv_block(512, 256)
        self.conv_decoder3 = self.conv_block(256, 128)
        self.conv_decoder2 = self.conv_block(128, 64)
        self.conv_decoder1 = self.conv_block(64, 32)
        self.conv_decoder0 = self.conv_block(32, 16)
        self.final_layer = self.final_block(16, 1)

        self.res_decoder4 = self.res_block(512, 256)
        self.res_decoder3 = self.res_block(255, 128)
        self.res_decoder2 = self.res_block(128, 64)
        self.res_decoder1 = self.res_block(64, 32)
        self.res_decoder0 = self.res_block(32, 16)

        self.upsample1 = nn.ConvTranspose1d(in_channels=512, out_channels=256, kernel_size=2, stride=2)
        self.upsample2 = nn.ConvTranspose1d(in_channels=256, out_channels=128, kernel_size=2, stride=2)
        self.upsample3 = nn.ConvTranspose1d(in_channels=128, out_channels=64, kernel_size=2, stride=2)
        self.upsample4 = nn.ConvTranspose1d(in_channels=64, out_channels=32, kernel_size=2, stride=2)
        self.upsample5 = nn.ConvTranspose1d(in_channels=32, out_channels=16, kernel_size=2, stride=2)
