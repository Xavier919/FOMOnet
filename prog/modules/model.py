...
class FOMOnet(nn.Module):
    ...
    def forward(self, x):
        ...
        upsamp5 = F.interpolate(x, e5_shape[-1])
        ...
        upsamp4 = F.interpolate(x, e4_shape[-1])
        ...
        upsamp3 = F.interpolate(x, e3_shape[-1])
        ...
        upsamp2 = F.interpolate(x, e2_shape[-1])
        ...
        upsamp1 = F.interpolate(x, e1_shape[-1])
